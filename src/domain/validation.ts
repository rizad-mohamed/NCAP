...
const persistedSectionSchemas = {
  ...
  articles: z.array(recordWithId),
  cyberTips: z.array(recordWithId),
  newsUpdates: z.array(recordWithId),
  bestPractices: z.array(recordWithId),
  posters: z.array(recordWithId),
  questions: z.array(recordWithId),
  infographics: z.array(recordWithId),
  videos: z.array(recordWithId),
